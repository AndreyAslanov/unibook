...
protocol LastYearViewDelegate: AnyObject {
    func didTapBookButton()
    func didTapPageButton()
}

final class LastYearView: UIControl {
    weak var delegate: LastYearViewDelegate?
    ...
    private func drawSelf() {
        ...
        numberBooksLabel.text = L.booksYear()
        numberPagesLabel.text = L.pagesYear()
