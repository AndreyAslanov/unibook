...
protocol NewFavouriteViewDelegate: AnyObject {
    func didTapFavButton()
}

final class NewFavouriteView: UIControl {
    weak var delegate: NewFavouriteViewDelegate?
